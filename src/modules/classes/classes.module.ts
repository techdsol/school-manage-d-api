...
@Module({
  imports: [
    SequelizeModule.forFeature([ClassType, Class, ClassSection, TeacherSpecialization, ClassTeacherAssignment, ClassSubject]),
    AcademicYearsModule,
    TeachersModule,
    SubjectsModule,
  ],
  controllers: [ClassTypesController, ClassesController, ClassSectionsController, TeacherSpecializationController, ClassTeacherAssignmentController, ClassSubjectController],
  providers: [ClassTypesService, ClassesService, ClassSectionsService, TeacherSpecializationService, ClassTeacherAssignmentService, ClassSubjectService],
  exports: [ClassTypesService, ClassesService, ClassSectionsService, TeacherSpecializationService, ClassTeacherAssignmentService, ClassSubjectService, SequelizeModule],
})
